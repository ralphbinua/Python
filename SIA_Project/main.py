...
# If you haven't set up auth.py yet, comment out the import and the login_user logic below
try:
    ...
    def login_user(u, p): return True, "Bypass" 
    def register_user(u, p): return True, "Bypass"
